...
package dibasics.helloword_0_1;
...
/**
 * Job: helloWord Purpose: my first Job<br>
 * Description: this job prints "hello word" in the console <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class helloWord implements TalendJob {
	...
	private final String jobName = "helloWord";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(helloWord.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_DIBASICS_helloWord = new byte[0];
		static byte[] commonByteArray_DIBASICS_helloWord = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DIBASICS_helloWord) {
...
///////////////////////    			
				...
				try {
					String content_tFileInputRaw_1 = org.apache.commons.io.FileUtils.readFileToString(
							new java.io.File("D:/DOCUMENTOS/Ayi-Academy/Talend/Files/GettingStarted/hello.txt"),
							"ISO-8859-15");
					row1.content = content_tFileInputRaw_1;
					globalMap.put("tFileInputRaw_1_FILENAME_PATH",
							"D:/DOCUMENTOS/Ayi-Academy/Talend/Files/GettingStarted/hello.txt");
...
///////////////////////		
				...
				if (row1.content != null) { //
					...
					strBuffer_tLogRow_1.append(String.valueOf(row1.content));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final helloWord helloWordClass = new helloWord();

		int exitCode = helloWordClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = helloWord.class.getClassLoader()
					.getResourceAsStream("dibasics/helloword_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = helloWord.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : helloWord");
		}
...
/************************************************************************************************
 * 33322 characters generated by Talend Open Studio for Data Integration on the
 * 12 de julio de 2022, 00:18:20 ART
 ************************************************************************************************/